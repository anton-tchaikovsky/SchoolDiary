...
class FakeRepositoryImpl : Repository {
    ...
    override suspend fun getTodayClasses(): List<Class> =
        listOf(
            ...
            Class("Literature", null, "Mrs. Barros", "09:00", "09:45", isBaseClass = true, false),
    ...
    override suspend fun getHomeworks(): List<Homework> =
        listOf(
            Homework("Literature", "Read scenes 1.1 - 1.12 of the Master and Margarita", "20.10.2023", listOf("Mike", "Mishel")),
            Homework("Physics", "Learn Newton's laws of motion","21.10.2023", listOf("Mike", "Bob")),
